...
//			bird가 날고 있으면 공격불가
			if(bird.getIsFly()) {
				System.out.println(other.getName() + "가 비행 중이라 공격할 수 없다.");
				return;
			}
		}
		
		System.out.println(this.name + "가 " + other.name + "에게 공격하려 합니다.");
		if(!other.isDead()) {
	...
	public void getDamage(float damage) {
		System.out.println(this.name + "가" + damage + "만큼 피해를 입습니다.");
