...
public class DrinkVendingMachineTest  {
	...
	public static void main(String[] args) {
		...
		Drink 박카스 = new Drink("박카스", 900, 0);
		Drink 몬스터 = new Drink("몬스터", 1500, 20);
		Drink 핫식스 = new Drink("핫식스", 1300, 10);
		Drink 밀키스 = new Drink("밀키스", 1400, 5);
		
		Machine lotte = new Machine(박카스, 몬스터, 핫식스, 밀키스);
		
		lotte.printAllDrinkInfo();
		
		System.out.println("=======================");
		
		int price = lotte.pressDrinkButton(0, 3, 10000);
		System.out.println(price);
		
		price = lotte.pressDrinkButton(1, 5, 10000);
		System.out.println(price);
		
		price = lotte.pressDrinkButton(2, 15, 10000);
		System.out.println(price);
		
		price = lotte.pressDrinkButton(3, 5, 10000);
		System.out.println(price);
		
		price = lotte.pressDrinkButton(4, 1, 10000);
		System.out.println(price);
